## OBS: O modelo pre-treinado do desafio está em logs/Rain100H/PReNet/
## OBS2: Para executar o treino novamente é necessario modificar o numero de imagens em DerainDataset.py
